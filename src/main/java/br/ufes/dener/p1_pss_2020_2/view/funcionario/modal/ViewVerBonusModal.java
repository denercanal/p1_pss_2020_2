package br.ufes.dener.p1_pss_2020_2.view.funcionario.modal;
...
public class ViewVerBonusModal extends javax.swing.JDialog {

    public ViewVerBonusModal(Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
